...
def _get_cross_packages (settings,
    ...
    return [
        Libc6 (settings).with (version=libc6_version, strip_dir=False,
                               mirror=download.glibc_deb, format='deb'),
        Libc6_dev (settings).with (version=libc6_version, strip_dir=False,
                                   mirror=download.glibc_deb, format='deb'),
        Linux_kernel_headers (settings).with (version=kernel_version, strip_dir=False,
