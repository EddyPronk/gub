...
'''
	...
	def configure (self):
		...
		self.system ('''cp %(lilywinbuilddir)s/bin/i586-mingw32msvc-libtool %(builddir)s/libtool''')
		self.system ('''cp %(lilywinbuilddir)s/bin/i586-mingw32msvc-libtool %(builddir)s/guile-readline/libtool''')
